...
<head>
    ...
    <link rel="stylesheet" href="../php-google-faq/style.css">
    <script src="https://use.fontawesome.com/0a1c4f296a.js"></script>
...
<body>
    <header>
        ...
        <div class="navbar">
            <ul>
                <li class="float-l"><a href="#">Introduzione</a></li>
                <li class="float-l"><a href="#">Norme sulla privacy</a></li>
                <li class="float-l"><a href="#">Termini di servizio</a></li>
                <li class="float-l"><a href="#">Tecnologie</a></li>
                <li class="float-l"><a href="#">Domande frequenti</a></li>
            </ul>
        </div>
    </header>
    <div class="container">
